...
/**
 * 数独的Java版解法_Lnho的专栏-CSDN博客  https://blog.csdn.net/Lnho2015/article/details/78632158
 */
...
//        };
        ...
        System.out.println(new Solution037Simple().solveSudoku(board));
        for (int i=0; i<9; i++){
    ...
    public int solveSudoku(char[][] board) {
        return recursion(board, initUnsolveMap(board));
    }
